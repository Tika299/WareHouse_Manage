...
{
    protected $fillable = ['sku', 'name', 'description', 'unit', 'cost_price', 'factor_retail', 'factor_wholesale', 'factor_ctv', 'factor_eco_margin', 'factor_eco_fee', 'stock_quantity', 'min_stock'];
